...
const rows = [
  ...
  ["frase", "preguntas", "真的吗？", "Zhēn de ma?", "¿En serio?", "真的 pregunta si algo es cierto y 吗 convierte la expresión en una pregunta de sí o no.", "真的吗？", "Zhēn de ma?", "¿En serio?", "—", "pregunta;confirmacion;conversacion"],
];
...
const properNamesById = new Map([
  ...
  ["FC067", "日本;Rìběn;Japón;Japan"],
  ["FC068", "韩国;Hánguó;Corea del Sur;South Korea"],
