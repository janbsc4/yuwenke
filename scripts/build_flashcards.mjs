...
const rows = [
  ...
  ["concepto", "pronombres", "他／她／它", "tā / tā / tā", "¿Qué diferencia hay entre 他, 她 y 它 al hablar y al escribir?", "Los tres se pronuncian tā; la diferencia aparece en la escritura: 他 se refiere normalmente a varones, 她 a mujeres y 它 a animales o cosas.", "他、她、它都读 tā。", "Tā, tā, tā dōu dú tā.", "Los tres caracteres se leen tā.", "1-2", "pronunciacion;pronombre"],

  ["concepto", "caracteres", "笔顺", "bǐshùn", "¿Qué es el orden de los trazos?", "Es el orden convencional que se sigue para escribir los trazos de un carácter.", "你", "nǐ", "tú", "1-3", "escritura;trazos"],
  ["concepto", "caracteres", "先左后右", "xiān zuǒ hòu yòu", "¿Qué componente se escribe primero en un carácter con partes a izquierda y derecha?", "Primero se escribe el componente de la izquierda y después el de la derecha.", "你", "nǐ", "El radical 亻 se escribe antes que 尔.", "1-3", "escritura;trazos"],
  ...
  ["concepto", "caracteres", "部首", "bùshǒu", "¿Qué es un radical y para qué sirve?", "Es el componente principal usado para clasificar un carácter en los diccionarios; cada carácter se clasifica por un radical aunque contenga varios componentes.", "您 → 心", "nín → xīn", "En 您, el radical de clasificación es 心.", "3", "radical;diccionario"],
  ...
  ["concepto", "puntuacion", "标点符号", "biāodiǎn fúhào", "¿Qué signos de puntuación usa el chino y qué diferencia hay con el español?", "El chino usa signos de ancho completo como ， 。 ！ y ？, y no emplea los signos españoles de apertura ¡ y ¿.", "你好！你好吗？", "Nǐ hǎo! Nǐ hǎo ma?", "¡Hola! ¿Estás bien?", "5", "puntuacion;escritura"],
  ...
  ["concepto", "saludos", "时间段＋好", "shíjiānduàn + hǎo", "¿Qué partes del día forman saludos habituales con 好?", "Sobre todo 早上好, 下午好 y 晚上好; 上午好 y 中午好 son posibles, pero menos habituales.", "下午好！", "Xiàwǔ hǎo!", "¡Buenas tardes!", "13", "patron;saludo"],
  ...
  ["frase", "presentaciones", "晚上好，您贵姓？", "Wǎnshang hǎo, nín guìxìng?", "Buenas noches. ¿Cuál es su apellido?", "Saludo nocturno seguido de la fórmula respetuosa 您贵姓 para preguntar el apellido.", "我姓孙。", "Wǒ xìng Sūn.", "Me apellido Sun.", "14", "dictado;formal;apellido"],
  ...
  ["concepto", "pronunciacion", "拼音", "pīnyīn", "¿Qué es el pinyin?", "Es el sistema que transcribe el mandarín con letras latinas y marcas de tono.", "nǐ hǎo", "nǐ hǎo", "hola", "15", "pronunciacion;escritura"],
  ["concepto", "pronunciacion", "声调", "shēngdiào", "¿Qué función cumplen los tonos en mandarín?", "Cada sílaba tiene un tono léxico o tono neutro, y el tono puede cambiar el significado.", "mā / má / mǎ / mà / ma", "mā / má / mǎ / mà / ma", "los cuatro tonos léxicos y el tono neutro, ilustrados con ma", "15", "pronunciacion;tono"],
  ...
  ["concepto", "pronunciacion", "标调优先顺序：a、o、e", "biāodiào yōuxiān shùnxù: a, o, e", "¿Qué vocal tiene prioridad al colocar una marca tonal?", "Si hay a, la marca va sobre a; si no, se da prioridad a o y e antes que a las demás vocales.", "hǎo", "hǎo", "En ao, la marca va sobre a.", "15", "pinyin;tono;regla"],
  ...
  ["concepto", "pronunciacion", "j、q、x 后的 ü 省略两点；零声母时写作 yu", "j, q, x hòu de ü shěnglüè liǎng diǎn; líng shēngmǔ shí xiězuò yu", "¿Cómo se escribe ü después de j, q o x y cuando no hay consonante inicial?", "Después de j, q o x se escribe u sin puntos; sin consonante inicial se escribe yu. Tras n o l se conservan los puntos.", "女 → nǚ；去 → qù；雨 → yǔ", "nǚ; qù; yǔ", "mujer; ir; lluvia", "15", "pinyin;u_dieresis;regla"],
